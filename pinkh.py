...
class Player:
    def __init__(self, x, y):
        ### Chargement du perso + Agrandissement
        self.sprite_original = pygame.image.load("images/pinkh_stable.png").convert_alpha()
        self.sprite = pygame.transform.scale(self.sprite_original,(self.sprite_original.get_width() * 2.5,self.sprite_original.get_height() * 2.5))
        ###
        ...
        self.direction = [0, 0] # Direction initiale (x,y)
